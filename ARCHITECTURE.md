...
При старте приложение проверяет обязательную конфигурацию и автоматически применяет EF Core миграции до запуска Telegram polling. Для ограниченного запуска можно задать единственный разрешенный Telegram User ID через конфигурацию.
