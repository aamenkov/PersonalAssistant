...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelegramAssistant.Domain.ConversationState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TelegramAssistant.Domain.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TelegramAssistant.Domain.RecurringPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TelegramAssistant.Domain.Reminder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TelegramAssistant.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TelegramAssistant.Domain.ConversationState", b =>
                {
                    b.HasOne("TelegramAssistant.Domain.User", "User")
                        .WithOne("ConversationState")
                        .HasForeignKey("TelegramAssistant.Domain.ConversationState", "UserId")
            ...
            modelBuilder.Entity("TelegramAssistant.Domain.PaymentTransaction", b =>
                {
                    b.HasOne("TelegramAssistant.Domain.RecurringPayment", "RecurringPayment")
